...
const (
	defaultControllerAgentName = "servicebindingprojection-controller"
	defaultFinalizerName       = "servicebindingprojections.internal.bindings.labs.vmware.com"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "internal.bindings.labs.vmware.com.ServiceBindingProjection"),
	)
