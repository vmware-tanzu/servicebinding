...
import (
	...
	v1alpha1 "github.com/vmware-labs/service-bindings/pkg/client/listers/labs/v1alpha1"
...
func (f *provisionedServiceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&labsv1alpha1.ProvisionedService{}, f.defaultInformer)
}
