...
import (
	...
	v1alpha2 "github.com/vmware-labs/service-bindings/pkg/client/listers/servicebinding/v1alpha2"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ServiceV1alpha2().ServiceBindings(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ServiceV1alpha2().ServiceBindings(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *serviceBindingInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&servicebindingv1alpha2.ServiceBinding{}, f.defaultInformer)
}
