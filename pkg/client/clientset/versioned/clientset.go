...
type Interface interface {
	...
	DuckV1alpha3() duckv1alpha3.DuckV1alpha3Interface
...
type Clientset struct {
	*discovery.DiscoveryClient
	duckV1alpha3           *duckv1alpha3.DuckV1alpha3Client
...
func NewForConfig(c *rest.Config) (*Clientset, error) {
	...
	var cs Clientset
	var err error
	cs.duckV1alpha3, err = duckv1alpha3.NewForConfig(&configShallowCopy)
	if err != nil {
		return nil, err
	}
...
func NewForConfigOrDie(c *rest.Config) *Clientset {
	var cs Clientset
	cs.duckV1alpha3 = duckv1alpha3.NewForConfigOrDie(c)
...
func New(c rest.Interface) *Clientset {
	var cs Clientset
	cs.duckV1alpha3 = duckv1alpha3.New(c)
