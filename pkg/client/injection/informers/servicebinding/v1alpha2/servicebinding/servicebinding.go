...
func Get(ctx context.Context) v1alpha2.ServiceBindingInformer {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/vmware-labs/service-bindings/pkg/client/informers/externalversions/servicebinding/v1alpha2.ServiceBindingInformer from context.")
	}
