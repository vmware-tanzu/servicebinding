...
import (
	...
	servicebinding "github.com/vmware-labs/service-bindings/pkg/client/injection/informers/servicebinding/v1alpha3/servicebinding"
	zap "go.uber.org/zap"
...
const (
	...
	defaultFinalizerName       = "servicebindings.servicebinding.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "servicebinding.io.ServiceBinding"),
	)
