...
type doReconcile func(ctx context.Context, o *v1alpha1.ProvisionedService) reconciler.Event
...
type reconcilerImpl struct {
	...
	Lister labsv1alpha1.ProvisionedServiceLister
...
func NewReconciler(ctx context.Context, logger *zap.SugaredLogger, client versioned.Interface, lister labsv1alpha1.ProvisionedServiceLister, recorder record.EventRecorder, r Interface, options ...controller.Options) controller.Reconciler {
...
func (r *reconcilerImpl) Reconcile(ctx context.Context, key string) error {
	...
	getter := r.Lister.ProvisionedServices(s.namespace)
...
func (r *reconcilerImpl) updateStatus(ctx context.Context, existing *v1alpha1.ProvisionedService, desired *v1alpha1.ProvisionedService) error {
