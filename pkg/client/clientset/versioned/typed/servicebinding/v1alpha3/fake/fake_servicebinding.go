...
var servicebindingsResource = schema.GroupVersionResource{Group: "servicebinding.io", Version: "v1alpha3", Resource: "servicebindings"}

var servicebindingsKind = schema.GroupVersionKind{Group: "servicebinding.io", Version: "v1alpha3", Kind: "ServiceBinding"}
...
func (c *FakeServiceBindings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha3.ServiceBinding, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(servicebindingsResource, c.ns, name), &v1alpha3.ServiceBinding{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha3.ServiceBinding), err
}

// List takes label and field selectors, and returns the list of ServiceBindings that match those selectors.
func (c *FakeServiceBindings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha3.ServiceBindingList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(servicebindingsResource, servicebindingsKind, c.ns, opts), &v1alpha3.ServiceBindingList{})
	...
	list := &v1alpha3.ServiceBindingList{ListMeta: obj.(*v1alpha3.ServiceBindingList).ListMeta}
	for _, item := range obj.(*v1alpha3.ServiceBindingList).Items {
...
func (c *FakeServiceBindings) Create(ctx context.Context, serviceBinding *v1alpha3.ServiceBinding, opts v1.CreateOptions) (result *v1alpha3.ServiceBinding, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(servicebindingsResource, c.ns, serviceBinding), &v1alpha3.ServiceBinding{})
...
func (c *FakeServiceBindings) Update(ctx context.Context, serviceBinding *v1alpha3.ServiceBinding, opts v1.UpdateOptions) (result *v1alpha3.ServiceBinding, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(servicebindingsResource, c.ns, serviceBinding), &v1alpha3.ServiceBinding{})
...
func (c *FakeServiceBindings) UpdateStatus(ctx context.Context, serviceBinding *v1alpha3.ServiceBinding, opts v1.UpdateOptions) (*v1alpha3.ServiceBinding, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(servicebindingsResource, "status", c.ns, serviceBinding), &v1alpha3.ServiceBinding{})
...
func (c *FakeServiceBindings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(servicebindingsResource, c.ns, name), &v1alpha3.ServiceBinding{})
...
func (c *FakeServiceBindings) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1alpha3.ServiceBindingList{})
	return err
}
...
func (c *FakeServiceBindings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha3.ServiceBinding, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(servicebindingsResource, c.ns, name, pt, data, subresources...), &v1alpha3.ServiceBinding{})
