...
import (
	...
	v1alpha2 "github.com/vmware-labs/service-bindings/pkg/client/listers/servicebindinginternal/v1alpha2"
...
func (f *serviceBindingProjectionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&servicebindinginternalv1alpha2.ServiceBindingProjection{}, f.defaultInformer)
}
