...
import (
	...
	servicev1alpha2 "github.com/vmware-labs/service-bindings/pkg/client/listers/service/v1alpha2"
	zap "go.uber.org/zap"
...
type reconcilerImpl struct {
	...
	Lister servicev1alpha2.ServiceBindingLister
...
func NewReconciler(ctx context.Context, logger *zap.SugaredLogger, client versioned.Interface, lister servicev1alpha2.ServiceBindingLister, recorder record.EventRecorder, r Interface, options ...controller.Options) controller.Reconciler {
...
func (r *reconcilerImpl) updateStatus(existing *v1alpha2.ServiceBinding, desired *v1alpha2.ServiceBinding) error {
