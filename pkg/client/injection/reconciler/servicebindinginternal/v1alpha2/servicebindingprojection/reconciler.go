...
func (r *reconcilerImpl) Reconcile(ctx context.Context, key string) error {
	...
	getter := r.Lister.ServiceBindingProjections(namespace)
...
func (r *reconcilerImpl) updateStatus(existing *v1alpha2.ServiceBindingProjection, desired *v1alpha2.ServiceBindingProjection) error {
